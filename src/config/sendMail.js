...
export const sendMail = async (emailReciever, otp) => {
  try {
    ...
    const info = await transport.sendMail({
      from: '"Hospital-management" Bomelatuyenhat12@gmail.com', // sender address
      to: `${emailReciever}`,
      subject: "Send OTP from Hospital-management", // Subject line
      text: `Your OTP for authentication is ${otp}`, // plain text body
      html: `<h4>Your OTP is <b>${otp}</b></h4>`, // html body
    })
    console.log(info)
  }
  catch (error) {
